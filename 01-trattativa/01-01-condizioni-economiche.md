...
**Stato: concordate verbalmente. Nessuna evidenza scritta.** ⚠️
...
Dettaglio operativo: [`../02-contratto/02-02-inquadramento-fiscale.md`](../02-contratto/02-02-inquadramento-fiscale.md)

## Struttura di pagamento 80 / 20
...
3. **Termine di pagamento** dopo l'esito positivo (es. 30 giorni data fattura).
4. **Contestazione parziale** → paga il non contestato, trattiene solo la quota in discussione.

Checklist documentale in lavorazione: [`../02-contratto/02-03-checklist-documentale.md`](../02-contratto/02-03-checklist-documentale.md)

## Costi a carico del fornitore italiano
...
> **Senza queste tre stime il margine non è calcolabile** e la ripartizione 50/50 resta teorica.
> È la prima cosa da quantificare, prima ancora della firma.

## Margine e ripartizione
...
Regole operative: [`../04-pagamenti/04-02-ripartizione-soci.md`](../04-pagamenti/04-02-ripartizione-soci.md)
