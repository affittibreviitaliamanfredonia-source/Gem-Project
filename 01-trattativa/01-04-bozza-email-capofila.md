# Bozza email alla capofila — tutte le domande in una volta

**Stato: 🟡 bozza del 18/09/2026, non inviata.**
Da inviare dall'**email di progetto**, dopo il parere della commercialista sulle domande 11 e 12
e dopo aver letto l'accordo già firmato da Luigi (molte risposte potrebbero essere già lì).
Le domande sono numerate come in [`../06-accordo-soci/domande-aperte.md`](../06-accordo-soci/domande-aperte.md),
sezione C, per riportare le risposte senza errori. Traduzione in spagnolo su richiesta.

Le parti tra `[ ]` vanno compilate o tolte prima dell'invio.
...
- **il prezzo**: i 2.000 € per studente si riferivano a un soggiorno di 92 giorni; questo gruppo resta
  62 giorni, come il gruppo di marzo–maggio 2026. Vi chiediamo di indicarci **l'importo previsto per il
  formato da 62 giorni** `[se Luigi conferma la cifra 2026: "confermate che resta X € come nel 2026?"]` e
  di confermare che il pacchetto resta lo stesso;
- corrispettivo per ospite `[da confermare]` **netto**, comprensivo di alloggio, trasferimenti di
  ...
  **esclusi i voli**;
- pagamento **80 % all'arrivo** dei ragazzi (fattura emessa qualche giorno prima) e **20 % alla
  consegna** di valutazioni, certificati e documentazione firmata;
- fatturazione dall'impresa **IACONETA GIANLUCA**, P.IVA IT04175780719, Manfredonia, in regime
  di inversione contabile intracomunitaria.

Se qualcosa non corrisponde, vi chiedo di segnalarcelo subito.

**1. Chi siete e chi firma** *(domanda 18)*
Ragione sociale completa, forma giuridica, **numero di partita IVA intracomunitario (VAT)**,
...
**3. Numero di ospiti, minimo garantito e variazioni** *(domanda 20)*
36 è il numero di oggi. Entro quale data il numero diventa **definitivo**? Sotto quale numero
il contratto si considera modificato? Cosa succede in caso di rinuncia di un ospite prima
dell'arrivo, di mancato arrivo, di rientro anticipato o di **ospiti in più**? Per gli alloggi
dobbiamo impegnarci con i proprietari con largo anticipo: un **minimo garantito** con relativa
penale ci permette di farlo senza rischio per nessuno.

**4. Età dei ragazzi e minorenni** *(domande 21 e 21b)*
Quanti ospiti saranno **minorenni** alla data di arrivo e con quale età? Chi esercita la
responsabilità su di loro durante il soggiorno (un tutor vostro sul posto?). Vi invieremo
una **bozza di manleva e consenso** da far firmare a genitori o tutori (regolamento della casa,
aspetti sanitari, privacy, uscite): vi chiediamo di dirci se va bene così, se preferite
...
ragazzi il primo giorno con il tutor. Vi chiediamo: chi definisce gli **ambiti** di ciascun
ragazzo e entro quando li riceviamo; con quale **forma giuridica** i ragazzi stanno in azienda
(tirocinio curricolare, mobilità Erasmus+, altro) e quale documento dobbiamo far firmare
all'azienda; chi copre **infortuni e responsabilità civile** durante le ore in azienda; cosa
...
trattenga solo la quota di quell'ospite; il **termine di pagamento** di ciascuna tranche
...
sintesi dei vincoli che prevede (durata, rinuncia, penali), per allineare le regole della casa.

So che sono molti punti. Li abbiamo messi tutti in una volta per non tornare a disturbarvi:
una vostra risposta anche parziale ci permette di andare avanti sugli alloggi, che sono la
parte con i tempi più lunghi. Restiamo a disposizione per una videochiamata, se preferite
chiarire a voce e poi confermare per iscritto.
