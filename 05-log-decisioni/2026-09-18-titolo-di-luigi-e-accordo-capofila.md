# 2026-09-18 · Titolo per la quota di Luigi, accordo con la capofila, codice ATECO

- **Stato:** ✅ Attiva
- **Decisa da:** Gianluca Iaconeta (risposte in chat del 18/09)
- **Sostituisce:** —
- **Sostituita da:** —

## Decisioni

1. **Luigi non ha partita IVA.** Proposta dei soci: la sua quota come "regalo tra privati".
   Registrata **con riserva**: una donazione di quella cifra richiede atto notarile con testimoni
   (art. 782 c.c.), un compenso travestito da regalo è riqualificabile, e senza documento la metà
   di Luigi non è un costo per Gianluca, che pagherebbe l'IRPEF su tutto il margine. Alternativa
   proposta: ricevuta per prestazione occasionale con ritenuta d'acconto (art. 7.2, nuova opzione).
   Decisione finale con la commercialista.
2. **Un accordo scritto con la capofila esiste ed è firmato da Luigi.** Probabilmente andrà
...
4. **Email di progetto: garganoeuropemobility@gmail.com** (dal 19/09; il 18/09 era stata creata
   progettogem@gmail.com, poi accantonata). Cartella Drive e registro
