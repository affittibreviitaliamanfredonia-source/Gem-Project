...
**Fino a quando i tre costi non sono stimati, il margine non è calcolabile.** È la prima cosa da fare.
...
|---|---|---|
| Scrittura privata firmata | 15/10/2026 | Interna |
| Risposte capofila + parere commercialista | 31/10/2026 | Proposta |
...
## 7. Cosa ci impegniamo a fare, ciascuno

- A leggere e aggiornare il README della repository come **unica descrizione dello stato** del progetto.
- A registrare ogni movimento nel foglio condiviso entro 3 giorni.
- A non assumere impegni verso terzi senza il consenso dell'altro, nei casi previsti dalla scrittura privata.
- A rispondere all'altro socio entro 48 ore su questioni che riguardano il progetto.
- A tenere il progetto separato dalle rispettive altre attività: conto, mail, documenti.

---

**Letto, condiviso e sottoscritto** come Allegato A della scrittura privata.
