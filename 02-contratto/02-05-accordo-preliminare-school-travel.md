...
| Elemento | Nel testo |
|---|---|
| Titolo | *Collaboration Agreement between Gargano Europe Mobility and Inversión y Educación S.L.* |
| Parte italiana | **Gargano Europe Mobility**, P.IVA **04566340719**, sede Manfredonia 71043 (FG) |
| Parte spagnola | **Inversión y Educación S.L.**, VAT **ESB83018630**, López de Hoyos 6, Madrid, rappresentata da **Iñigo Álvarez Valdés** |
| Oggetto | Collaborare per organizzare e inviare **da 1 a 42 studenti** a tirocini in aziende di vari settori **in Europa**, tra il 2026 e il 2027 |
| Compiti di GEM | Selezionare e preparare gli studenti; coordinare la documentazione per viaggio e soggiorno; seguire progresso e benessere durante i tirocini |
| Compiti di Inversión y Educación | Fornire informazioni e contatti con aziende ospitanti in vari paesi europei, **Italia compresa**; aiutare a organizzare orientamento e formazione prima della partenza; supporto continuo durante il tirocinio |
| Durata | Dalla firma fino alla conclusione dei tirocini, **agosto 2027** |
| Firme | Per GEM: nome in bianco. Per I&E: Iñigo Álvarez Valdés |

Lunghezza: una pagina, circa 1.400 caratteri. Nessuna tabella, nessun allegato, nessuna revisione.

## Cosa NON dice

Nessuno dei punti economici e operativi che regolano i 72.000 €:

- nessun **prezzo** (né 2.000 € né altro), nessun **80/20**, nessun termine di pagamento;
- nessuna **penale**, né a scaglioni né di altro tipo;
- nessun **numero** di 36 studenti: "da 1 a 42", senza minimo garantito;
- nessuna **data** di arrivo o durata: "2026–2027", fine agosto 2027, non 90 notti dal 1° marzo;
- nessun riferimento ad **alloggio in camera singola**, transfert, mobility, imposta di soggiorno;
- nessun elenco di **documenti** per il saldo, nessun controllo dei tutor;
- nessuna clausola su **danni, deposito, assicurazione, minorenni, dati personali**;
- nessuna **legge applicabile** né foro; nessuna lingua prevalente.

I punti che il 19/09 risultavano "scritti nell'agreement" (penale a scaglioni, documenti del
20 %, termini di pagamento: domande 20, 27, 28) **non sono in questo testo**. O esiste un altro
documento, o sono stati concordati a voce.

## Tre cose che cambiano il quadro

1. **I ruoli sono al contrario.** Il testo assegna a GEM i compiti di chi *invia* gli studenti
   (selezionarli, prepararli, curare la documentazione di viaggio) e a Inversión y Educación
   quelli di chi *fornisce contatti con aziende ospitanti in Italia*. Nel progetto GEM, invece,
   gli spagnoli mandano i ragazzi e noi li ospitiamo e li collochiamo. Probabilmente è un modello
...
3. **La controparte si chiama Inversión y Educación S.L.**, non School Travel. School Travel è
   ...
   commerciale. Il VAT **ESB83018630 è valido su VIES** (verifica del 20/09/2026; la Spagna non
   mostra nome e indirizzo). Nei contratti e nelle fatture va usata la denominazione legale.

## Conseguenze per i documenti del progetto

- Domande 18 e 19: la controparte e il suo VAT sono noti; il contratto B2B con prezzo, date,
  penali e 20 % **non esiste ancora** e va scritto da zero, o integrato con un allegato economico.
- Domande 20, 27, 28: riaperte. Le penali e i documenti del 20 % sono da negoziare per iscritto.
- README, Q2 e Q3: tornano rosse.
- Scrittura privata tra soci: la premessa a) e l'art. 2 dipendono dalla risposta su chi è GEM.
